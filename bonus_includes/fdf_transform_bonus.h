...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   fdf_transform_bonus.h                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: kshim <kshim@student.42seoul.kr>           +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/28 15:53:47 by kshim             #+#    #+#             */
/*   Updated: 2022/11/03 11:58:20 by kshim            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef FDF_TRANSFORM_BONUS_H
# define FDF_TRANSFORM_BONUS_H
...
void				ft_set_pers_projection_transform_matrix(
						t_fdf_rend_val *rend_val,
						t_project_tf_data *prj_tf_data,
						float prj_tf_all[4][4]);
